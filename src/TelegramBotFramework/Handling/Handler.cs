...
{
    private readonly List<FilterDelegate> _filterDelegates = [];
    private readonly Func<BotRequestContext, Task<IResult>> _handlerDelegate;

    public Handler(HandlerDelegate handlerDelegate)
    {
    ...
    public Handler Filter(FilterDelegate filterDelegate)
    {
